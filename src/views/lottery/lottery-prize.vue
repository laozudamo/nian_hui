  ...
  <div class="prize-wrap">
    <ul class="prize-list">
      <li class="prize-item" v-for="(item, index) in prizeList" :key="index"
        :class="{ shine: index === currentPrizeIndex, done: index === donePrizeIndex }" @click="selectPrize(item, index)">
        <div class="prize-item-left" v-if="true">
        ...
        <div class="prize-item-right">
          ...
          <div class="prize-item-count-wrap">
            ...
            <div class="progress">
              <div :style="{ width: item.countRemain / item.count * 100 + '%' }"
